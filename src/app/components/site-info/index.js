...
import { ReactComponent as BlueprintIcon } from '../../../../assets/svg/blueprint-icon.svg';
...
export const SiteInfoBar = () => {
    ...
    return (
        <div className="wppb-app-site-info nfd-bg-[#25253C] nfd-w-full nfd-py-6 nfd-px-8 nfd-mb-8 nfd-border nfd-border-line nfd-rounded-lg">
            <div className="nfd-flex nfd-justify-between nfd-items-center nfd-flex-wrap nfd-gap-4">
                ...
                <div className="nfd-w-max nfd-flex nfd-items-center nfd-flex-wrap nfd-gap-3">
                    <Button 
                        ...
                        href='https://www.blueprint.com/login'
                        target="_blank"
                        variant="primary" 
                        className="nfd-bg-primary-400 nfd-text-tiny nfd-w-full min-[400px]:nfd-w-auto">
                        <BlueprintIcon />
                        { __("Blueprint Account", "wp-plugin-blueprint") }
                    </Button>
                    <Button 
                        as="a" 
                    ...
                    >
                        <WordPressIcon />
                       { (isEcommerce && isStore) ? __("View Store", "wp-plugin-blueprint") : __("View Site", "wp-plugin-blueprint") }
                    </Button>
                </div>
