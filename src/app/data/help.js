const help = [
	{
		name: 'ticket',
		title: __( 'Email Us', 'wp-plugin-crazy-domains' ),
		description: __(
	...
	{
		name: 'twitter',
		title: __( 'Tweet', 'wp-plugin-crazy-domains' ),
		description: __(
			'Find our team at @crazydomains for updates on our products and support from our team.',
			'wp-plugin-crazy-domains'
		),
		icon: 'twitter',
		cta: __( 'Tweet Us', 'wp-plugin-crazy-domains' ),
		url: 'https://twitter.com/crazydomains',
	},
	{
		name: 'help',
	...
	{
		name: 'academy',
		title: __( 'Online Academy', 'wp-plugin-crazy-domains' ),
		description: __(
	...
	{
		name: 'blog',
		title: __( 'Blog', 'wp-plugin-crazy-domains' ),
		description: __(
			'Learn best practices, get insider tips and find the latest news about Crazy Domains.',
			'wp-plugin-crazy-domains'
		),
		icon: 'text-page',
	...
	{
		name: 'video',
		title: __( 'Video Tutorials', 'wp-plugin-crazy-domains' ),
		description: __(
			'Check out our video library of step-by-step tutorials.',
			'wp-plugin-crazy-domains'
		),
		icon: 'format-video',
		cta: __( 'Watch Now', 'wp-plugin-crazy-domains' ),
		url: 'https://www.youtube.com/user/CrazyDomains',
	},
];
